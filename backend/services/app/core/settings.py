...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        oidc_client_id=normalize_env_text(os.getenv("OIDC_CLIENT_ID", "")),
        ...
        import_network_timeout_seconds=max(0.5, float(normalize_env_text(os.getenv("IMPORT_NETWORK_TIMEOUT_SECONDS", "60")))),
