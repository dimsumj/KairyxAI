...
- `Experiment Hub`: experiment config, assignment, exposure, outcome, summary, integrity checks, decision logging, AI/RAG evaluation telemetry, deterministic auto-grading, model-judge/offline evaluation runs, AI Quality Monitor, AI feedback records, and feedback-learning profiles with Ask AI handoffs for setup and diagnostics
...
4. `Evaluation And Monitoring`: expand the delivered AI/RAG evaluation telemetry, deterministic grading APIs, model-judge/offline eval adapters, and AI Quality Monitor into scheduled alert jobs for retrieval quality, answer relevance, citation coverage, campaign-copy usefulness, and prompt-to-artifact completion rates.
...
3. `Evaluation And Monitoring`
   - Delivered AI/RAG evaluation telemetry records, summaries, deterministic auto-grading, model-judge/offline evaluation run adapters, and the Experiment Hub AI Quality Monitor for retrieval quality, answer relevance, citation coverage, campaign-copy usefulness, prompt-to-artifact completion, feedback diagnostics, coverage gaps, and judge-readiness lanes
   - Next, add scheduled alert jobs for stale sources, missing evidence, unsupported prompts, and eval drift
4. `Feedback Loop`
