...
- `Insight Copilot` for the prompt-first Ask AI command center, grounded operator help, summaries, recommendations, confirmations, artifacts, and evidence-backed reporting
